...
@Composable
fun select_avaiable_car(navController: NavController) {
	Column(
		modifier = Modifier
			.fillMaxWidth()
			.fillMaxHeight()
		...
		Column(
			...
			Column(
				...
				Row(
					...
					CoilImage(
						imageModel = {"https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/db1af2dc-8d38-4208-b82e-aad9b15f14a5"},
					...
					CoilImage(
						imageModel = {"https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/42277eb7-36d6-405b-8239-43eefca9e455"},
						imageOptions = ImageOptions(contentScale = ContentScale.Crop),
						modifier = Modifier
							.width(66.dp)
							.height(11.dp)
...
@Composable
fun select_available_car_Preview() {
	TransportTheme {
		select_avaiable_car(navController = rememberNavController())
	}
}